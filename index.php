  ...
  <body id="page-top">
    ...
    <section class="callout">
      <div class="container text-center">
        ...
        <a class="btn btn-primary btn-xl" href="https://startbootstrap.com/template-overviews/stylish-portfolio/">Sign-in Now!</a>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-6 col-md-12">
            <a class="portfolio-item" href="#" sytle="width: 100%; height: 50%; ">
              <span class="caption" >
